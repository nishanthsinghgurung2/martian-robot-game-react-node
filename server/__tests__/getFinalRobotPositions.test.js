...
describe('getFinalRobotPositions', () => {
    ...
    it('should get the final positions of the robot that falls', () => {
        ...
        assert.deepEqual(getFinalRobotPositions(robotsMovementsInput2),['3 3 N LOST']);
    })
    ...
    it('should get the final positions of the robots that has a mix of ones that falls and the others that doesnt', () => {
        const robotsMovementsInput2 = {
         ...
         assert.deepEqual(getFinalRobotPositions(robotsMovementsInput2),[ '1 1 E', '3 3 N LOST', '2 3 S' ]);
     })
    ...
    describe('Errors', () => {
        ...
        it('should error when input is invalid', () => {
            ...
            const getFinalRobotPositionsError = () => getFinalRobotPositions(robotsMovementsInput);
            assert.throws(getFinalRobotPositionsError, Error, 'Invalid upper coordinates');
        })
        it('should error when robots positions are invalid', () => {
            ...
            assert.deepEqual(getFinalRobotPositions(robotsMovementsInput), ['Invalid robot position']);
        })
        it('should error when robots instructions are invalid', () => {
            ...
            assert.deepEqual(getFinalRobotPositions(robotsMovementsInput), ['Invalid robot instruction']);
        })
    })
})