...
var recordLostCoords = function recordLostCoords(robotCurrentCoords, robotLostCoords, robotsNewPositions) {
...
var moveRobotAndGetNewCords = function moveRobotAndGetNewCords(robotCurrentCoords, boundaryCoords, robotLostCoords, robotsNewPositions) {
...
var isRobotPositionInvalid = function isRobotPositionInvalid(robotPosition) {
  if (robotPosition && typeof robotPosition === 'string') {
    ...
    if (robotPositionArr.length == 3 && Number(robotPositionArr[0]) >= 0 && Number(robotPositionArr[0]) <= 50 && Number(robotPositionArr[1]) >= 0 && Number(robotPositionArr[1]) <= 50 && (robotPositionArr[2] === 'N' || robotPositionArr[2] === 'E' || robotPositionArr[2] === 'W' || robotPositionArr[2] === 'S')) {
      return false;
    }
  }
...
var isRobotInstructionInvalid = function isRobotInstructionInvalid(robotInstruction) {
...
var isUpperCoordsInvalid = function isUpperCoordsInvalid(upperCoords) {
  ...
  if (upperCoords && typeof upperCoords === 'string') {
    ...
    if (boundaryCoords.length === 2 && Number(boundaryCoords[0]) >= 0 && Number(boundaryCoords[0]) <= 50 && Number(boundaryCoords[1]) >= 0 && Number(boundaryCoords[1]) <= 50) {
